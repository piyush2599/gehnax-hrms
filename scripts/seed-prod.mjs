...
console.log("  HR Admin    : hr@hrms.com        / Hr@123456");
console.log("  Employee    : john@hrms.com      / Emp@123456");
console.log("  Manager     : rohan.verma@hrms.com / Welcome@123");
