          ...
          <div style="font-family:sans-serif;max-width:600px;margin:auto;background:#f8fafc;border-radius:12px;overflow:hidden">
            ...
            <div style="padding:32px">
              ...
              <div style="margin:28px 0">
                <a href="${process.env.NEXTAUTH_URL ?? "https://myapp.gehnax.com"}/api/public/hiring/offer/${params.id}" style="display:inline-block;background:#2563eb;color:#fff;padding:14px 32px;border-radius:8px;text-decoration:none;font-weight:700;font-size:15px">Download Offer Letter</a>
              </div>
